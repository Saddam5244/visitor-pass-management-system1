...
- **Live Web Application**: [https://visitor-pass-5244.web.app](https://visitor-pass-5244.web.app)

PassPulse is an enterprise-grade **Visitor Pass Management System** built with the **MERN Stack** (MongoDB, Express, React, Node.js). Designed to replace archaic paper entry logs, PassPulse digitizes the complete visitor lifecycle: staff onboarding, visitor appointment requests, OTP verification, host approval workflows, cryptographic QR badge generation, live webcam check-in/out scanning, overstay alerts, audit trails, and multi-campus support.
...
### 2. Visitor Registration & Photo Capture
- Security desk & Host pre-registration interface.
